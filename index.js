...
console.log(createMenuItem("Fryied Chickens", 12, "dinner"));
...
console.log('Task 5', addReview(reviews, "Lucas", 10, "Great food, love the vibe!"));     
